...
<section class="admin-dashboard-grid admin-dashboard-grid--main">
    <article class="admin-panel admin-chart-panel">
        ...
        <div id="chart-container" style="height: 250px; display: flex; align-items: center; justify-content: center; color: #a0a3ab; border: 1px dashed #e0e2e5; border-radius: 8px;">
    ...
    <article class="admin-panel admin-activity-panel">
        ...
        <div id="activity-list-container" style="display: none; display: flex; flex-direction: column; gap: 12px; margin-top: 15px;">
...
<section class="admin-dashboard-grid admin-dashboard-grid--bottom">
    <article class="admin-panel admin-table-panel">
        <div class="admin-panel__head">
            ...
            <a href="{{ url('/admin/transaksi') }}" class="admin-panel__link">Kelola transaksi</a>
        </div>
