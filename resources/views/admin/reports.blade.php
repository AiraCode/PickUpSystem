...
@section('content')
    <div class="admin-page-heading">
        ...
        <div style="display:flex; align-items:center; gap:8px;">
            ...
            <select id="report-year-select" class="admin-select"
                style="padding:6px 12px; font-size:13px; font-weight:600; border-radius:6px; background:#fff;">
    ...
    <div style="display: grid; grid-template-columns: repeat(4, minmax(0, 1fr)); gap: 16px; margin-bottom: 24px;">
        <article class="admin-panel admin-stat-card" style="margin:0;">
            ...
            <div class="admin-stat-card__value" id="report-stat-sales"
                style="font-size:22px; font-weight:700; color:#111318; margin:6px 0 4px;">Rp 0</div>
        ...
        <article class="admin-panel admin-stat-card" style="margin:0;">
            ...
            <div class="admin-stat-card__value" id="report-stat-orders"
                style="font-size:22px; font-weight:700; color:#111318; margin:6px 0 4px;">0</div>
            <p class="admin-stat-card__note" id="report-stat-completed-note"
                style="margin:0; font-size:11px; color:#6d727c;">0 Selesai</p>
        </article>

        <article class="admin-panel admin-stat-card" style="margin:0;">
            <span class="admin-stat-card__eyebrow">RATA-RATA TRANSAKSI</span>
            <div class="admin-stat-card__value" id="report-stat-avg"
                style="font-size:22px; font-weight:700; color:#111318; margin:6px 0 4px;">Rp 0</div>
        ...
        <article class="admin-panel admin-stat-card" style="margin:0;">
            ...
            <div class="admin-stat-card__value" id="report-stat-cancelled"
                style="font-size:22px; font-weight:700; color:#ba1b2b; margin:6px 0 4px;">0 (0%)</div>
    ...
    <article class="admin-panel admin-chart-panel" style="margin-bottom: 24px;">
        ...
        <div id="chart-bars-container"
            style="height: 250px; display: flex; align-items: flex-end; justify-content: space-between; gap: 8px; padding: 20px 10px 10px; border-bottom: 1px solid #e5e7eb; position: relative;">
            <div
                style="position:absolute; inset:0; display:flex; flex-direction:column; justify-content:space-between; pointer-events:none; opacity:0.15; z-index:0;">
                <div style="border-top:1px dashed #000; width:100%;"></div>
                <div style="border-top:1px dashed #000; width:100%;"></div>
                <div style="border-top:1px dashed #000; width:100%;"></div>
            </div>
        </div>
        <div id="chart-labels-container"
            style="display: flex; justify-content: space-between; gap: 8px; padding: 8px 10px 0;">
        </div>
    </article>
            ...
            <div class="admin-table-wrap">
                <table class="admin-table admin-table--compact">
                    ...
                    <tbody id="top-accus-tbody">
                        <tr>
                            <td colspan="3">
                                <div class="admin-table-empty">Memuat data...</div>
                            </td>
                        </tr>
                    </tbody>
                </table>
