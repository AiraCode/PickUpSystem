...
<div id="modal-view-city-prices" style="display:none; position:fixed; inset:0; background:rgba(0,0,0,.45); z-index:100; align-items:center; justify-content:center;">
    <div class="admin-panel" style="width:740px; max-width:92vw; max-height:90vh; overflow-y:auto; overflow-x:hidden;">
        <div class="admin-panel__head" style="display:flex; justify-content:space-between; align-items:center; gap:12px; flex-wrap:wrap;">
            <div>
                <h2 id="city-price-modal-title">Daftar Harga Aki Kota</h2>
                <p style="font-size:12px; color:#6d727c; margin-top:2px;">Atur dan edit harga aki khusus untuk area layanan ini.</p>
            </div>
            <button class="admin-button admin-button--primary" style="height:32px; font-size:12px; white-space:nowrap;" onclick="openAddPriceForCurrentCity()">+ Tambah Harga</button>
        </div>
        <div class="admin-table-wrap" style="margin-top:12px; overflow-x:hidden;">
            <table class="admin-table" style="width:100%;">
                ...
                <tbody id="modal-city-accus-tbody">
                    <tr><td colspan="4"><div class="admin-table-empty"><strong>Memuat data harga...</strong></div></td></tr>
                </tbody>
            </table>
        </div>
        <div style="display:flex; justify-content:flex-end; margin-top:16px;">
            <button type="button" class="admin-button admin-button--secondary" onclick="document.getElementById('modal-view-city-prices').style.display='none'">Tutup</button>
        </div>
    </div>
</div>
...
<div id="modal-add-accu" style="display:none; position:fixed; inset:0; background:rgba(0,0,0,.45); z-index:100; align-items:center; justify-content:center;">
    <div class="admin-panel" style="width:420px;">
        <div class="admin-panel__head"><h2>Tambah Aki Baru</h2></div>
...
<div id="modal-set-price" style="display:none; position:fixed; inset:0; background:rgba(0,0,0,.45); z-index:110; align-items:center; justify-content:center;">
    <div class="admin-panel" style="width:420px;">
        <div class="admin-panel__head"><h2 id="set-price-modal-head">Atur Harga Aki</h2></div>
        <form id="form-set-price">
            <div style="margin-bottom:16px;">
                <label style="display:block; font-size:12px; font-weight:600; margin-bottom:6px; color:#4a4f59;">Kota Layanan</label>
            ...
            <div style="margin-bottom:16px;">
                <label style="display:block; font-size:12px; font-weight:600; margin-bottom:6px; color:#4a4f59;">Harga Aki (Rp)</label>
