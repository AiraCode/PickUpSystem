            ...
            <section class="user-catalog user-section" id="daftar-harga">
                <div class="user-container">
                    ...
                    <div class="user-catalog-toolbar">
                        ...
                        <span class="user-catalog-toolbar__status" data-city-status>Data harga mengikuti wilayah yang
                            dipilih.</span>
                    </div>

                    <div class="user-catalog-layout">
                        <div class="user-product-grid">
                            <article class="user-product-card" data-product-card data-product-name="GS Astra NS40"
                                data-product-brand="GS Astra" data-product-price="0">
                                <div class="user-product-card__image">
                                    <img src="{{ asset('images/not-found/batteries/gs-astra-ns40.jpg') }}"
                                        alt="GS Astra NS40 belum tersedia (not found)">
                                ...
                                <div class="user-product-card__body">
                                    ...
                                    <div class="user-product-card__info"><span>Kondisi diverifikasi saat serah
                                            terima</span><b>Stok mengikuti data sistem</b></div>
                                    <strong class="user-product-card__price" data-product-price-label>Harga belum
                                        tersedia</strong>
                                    <div class="user-product-card__actions">
                                        <div class="user-quantity">
                                            <button type="button" data-quantity-minus
                                                aria-label="Kurangi jumlah GS Astra NS40">−</button>
                                            <input type="number" value="1" min="1" max="99" data-quantity
                                                aria-label="Jumlah GS Astra NS40">
                                            <button type="button" data-quantity-plus
                                                aria-label="Tambah jumlah GS Astra NS40">+</button>
                                        </div>
                            ...
                            <article class="user-product-card" data-product-card data-product-name="Yuasa YBX"
                                data-product-brand="Yuasa" data-product-price="0">
                                <div class="user-product-card__image">
                                    <img src="{{ asset('images/not-found/batteries/yuasa-ybx.jpg') }}"
                                        alt="Yuasa YBX belum tersedia (not found)">
                                    <span class="user-image-not-found">Gambar · not found</span>
                                    <span class="user-product-card__tag">AKI MOBIL</span>
                                </div>
                                <div class="user-product-card__body">
                            ...
                            <article class="user-product-card" data-product-card data-product-name="Incoe MF"
                                data-product-brand="Incoe" data-product-price="0">
                                <div class="user-product-card__image">
                                    <img src="{{ asset('images/not-found/batteries/incoe-mf.jpg') }}"
                                        alt="Incoe MF belum tersedia (not found)">
                                    <span class="user-image-not-found">Gambar · not found</span>
                            ...
                            <article class="user-product-card" data-product-card data-product-name="Delkor 55D23L"
                                data-product-brand="Delkor" data-product-price="0">
                                <div class="user-product-card__image">
                                    <img src="{{ asset('images/not-found/batteries/delkor-55d23l.jpg') }}"
                                        alt="Delkor 55D23L belum tersedia (not found)">
                                    <span class="user-image-not-found">Gambar · not found</span>
                                    <span class="user-product-card__tag">AKI MOBIL</span>
                                </div>
                                <div class="user-product-card__body">
                        ...
                        <aside class="user-checkout-card" aria-label="Ringkasan penjualan">
                            ...
                            <div class="user-delivery" data-delivery-method>
                                ...
                                <label class="user-radio-card">
                                    ...
                                    <span class="user-radio-card__indicator"></span>
                                    <span><strong>Dijemput kurir Indoprima</strong><small>Biaya penjemputan akan dihitung
                                            berdasarkan jarak.</small></span>
                                </label>
                            </div>
                            ...
                            <div class="user-address">
                                ...
                                <div class="user-address__row">
                                    ...
                                    <label class="user-floating-field"><input type="text" placeholder=" "><span>Kode
                                            pos</span></label>
                                </div>
