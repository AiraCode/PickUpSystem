    ...
    <body class="admin-shell">
        <div class="admin-layout" data-admin-app>
            ...
            <aside class="admin-sidebar" id="admin-sidebar" aria-label="Navigasi utama admin">
                ...
                <nav class="admin-nav">
                    <a href="{{ url('/admin/dashboard') }}" class="admin-nav__link {{ request()->is('admin/dashboard') ? 'is-active' : '' }}" data-nav-link>
                    ...
                    <a href="{{ url('/admin/transaksi') }}" class="admin-nav__link {{ request()->is('admin/transaksi') ? 'is-active' : '' }}" data-nav-link>
                        <svg viewBox="0 0 24 24" aria-hidden="true"><path d="M4 5.5h16v13H4z" /><path d="M8 9h8M8 13h5" /></svg>
                        <span>Transaksi Masuk</span>
                    </a>
                    <a href="{{ url('/admin/harga') }}" class="admin-nav__link {{ request()->is('admin/harga') ? 'is-active' : '' }}" data-nav-link>
                        <svg viewBox="0 0 24 24" aria-hidden="true"><path d="M5 5h14v14H5z" /><path d="M8 9h8M8 13h8M8 17h5" /></svg>
                        <span>Harga Aki</span>
                    </a>
                    <a href="{{ url('/admin/gudang') }}" class="admin-nav__link {{ request()->is('admin/gudang') ? 'is-active' : '' }}" data-nav-link>
                    ...
                    <a href="{{ url('/admin/pengguna') }}" class="admin-nav__link {{ request()->is('admin/pengguna') ? 'is-active' : '' }}" data-nav-link>
                        <svg viewBox="0 0 24 24" aria-hidden="true"><circle cx="12" cy="8" r="3.5" /><path d="M5 20c.8-3.2 3.1-5 7-5s6.2 1.8 7 5" /></svg>
                        <span>Pengguna</span>
                    </a>
                    <a href="{{ url('/admin/laporan') }}" class="admin-nav__link {{ request()->is('admin/laporan') ? 'is-active' : '' }}" data-nav-link>
