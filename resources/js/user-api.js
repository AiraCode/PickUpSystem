    ...
    if (citySelect) {
        ...
        (async () => {
            ...
            if (res.data && res.data.length) {
                ...
                const savedCityId =
                    localStorage.getItem("pickup_city_id") || res.data[0].id;
            ...
            const match =
                accus.find(
                    (a) =>
                        (a.name &&
                            productName &&
                            a.name.toLowerCase().includes(productName)) ||
                        (a.brand &&
                            productBrand &&
                            a.brand.toLowerCase().includes(productBrand)),
    ...
    if (identityForm) {
        ...
        identityForm.addEventListener("submit", (e) => {
            ...
            formDataToSubmit = {
                ...
                account_name:
                    form.querySelector('input[name="account_holder"]')?.value ||
                    "",
                account_number:
                    form.querySelector('input[name="account_number"]')?.value ||
                    "",
            ...
            (async () => {
                ...
                if (res.data) {
                    ...
                    if (blockPenyerahan) {
                        ...
                        if (dds[0])
                            dds[0].textContent = "Dijemput Kurir Indoprima";
                        if (dds[1])
